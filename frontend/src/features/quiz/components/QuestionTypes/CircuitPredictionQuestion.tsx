...
interface CircuitPredictionQuestionProps {
  question: Question;
...
export const CircuitPredictionQuestion: React.FC<CircuitPredictionQuestionProps> = ({
  question,
  selectedAnswer,
  onSelect,
  disabled
  ...
  return (
    <div className="space-y-4 font-sans">
      <div className={cn(
        ...
        [Circuit Simulation Read-Only Embed]
        <div className={cn("mt-2 font-sans text-xs", isDark ? "text-zinc-400" : "text-zinc-600")}>
          Analyze the circuit quantum state vector evolution to predict output probability distribution.
        </div>
      </div>
