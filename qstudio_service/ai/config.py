...
# (QPilot, qBook's per-cell AI assistant — lives in backend/, not this
# service, but this copy is kept in sync per this package's own convention).
# Mistral first, then Groq, remaining providers kept in their prior relative
# order.
